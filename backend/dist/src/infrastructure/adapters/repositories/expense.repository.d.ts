...
export declare class ExpenseRepository implements IExpenseRepositoryPort {
    ...
    createDebts(expenseId: string, debts: {
        fromUserId: string;
        toUserId: string;
        amount: number;
        eventId: string;
    ...
    createGuestDebts(expenseId: string, debts: {
        fromUserId?: string;
        fromGuestId?: string;
        toGuestId: string;
        amount: number;
    ...
    updateGuestDebt(id: string, data: {
        isPaid?: boolean;
        paidAt?: Date;
    }): Promise<any>;
    ...
    createGuestDebtsToUser(expenseId: string, debts: {
        fromGuestId: string;
        toUserId: string;
        amount: number;
        eventId: string;
